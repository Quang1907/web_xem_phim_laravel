    ...
    <div class="row container" id="wrapper">
        <div class="halim-panel-filter">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{ $find_slug->title }}</a> » <span
                                ...
                                <a class="halim-thumb" href="{{ route('movie', $model->slug) }}"
                                    ...
                                    <div class="halim-post-title-box">
                                        <div class="halim-post-title ">
                                            <p class="entry-title">{{ $model->title }}</p>
                                            <p class="original_title">{{ $model->name_eng }}</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
